...
$app->post('/api/Bitly/getTrackingDomainShortenCounts', function ($request, $response) {
    ...
    if(isset($post_data['args']['rollup'])){
        $data['rollup'] = $post_data['args']['rollup'];
    }

    $query_str = $settings['api_url'] . "user/tracking_domain_shorten_counts";
